...
export const Brc20TokenResponseSchema = Type.Object(
  {
    ...
    holders: Type.Integer({ examples: [100] }),
  },
...
export const Brc20MintResponseSchema = Type.Object(
  {
    id: Type.String({
      examples: ['1463d48e9248159084929294f64bda04487503d30ce7ab58365df1dc6fd58218i0'],
    }),
    ...
    minted_supply: Type.String({ examples: ['1000000'] }),
    max_supply: Type.String({ examples: ['21000000'] }),
    mint_count: Type.Integer({ examples: [5] }),
    holders: Type.Integer({ examples: [100] }),
  },
  { title: 'BRC-20 Mint Information Response' }
);
export type Brc20MintResponse = Static<typeof Brc20MintResponseSchema>;

export const Brc20StatResponseSchema = Type.Object(
  {
    total: Type.Integer({ examples: [2000] }),
    tx_count: Type.Integer({ examples: [300000] }),
    holders: Type.Integer({ examples: [100] }),
  },
  { title: 'BRC-20 Statistics Response' }
);
export type Brc20StatResponse = Static<typeof Brc20StatResponseSchema>;
